        ...
        if (notifications.size() > 0) {
            ...
            for (Notification n : notifications) {
                ...
                if (user != null) {
                    ...
                    if(n.getGroupId().getPortarit()==null||n.getGroupId().getPortarit().equals("")){
                        sendNotification.setGroupPortrait(WebSocketOperateUtil.Portrait_Image_Group);
                    }else{
                        sendNotification.setGroupPortrait(WebSocketOperateUtil.Portrait_Url+n.getSendUserId().getPortrait()+WebSocketOperateUtil.Portrait_Suffix);
                    }
